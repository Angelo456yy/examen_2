...
namespace Parcial_2
{
    internal class Program
    {
        ...
        {
            // Crear el archivo empleados.txt si no existe
            if (!File.Exists("empleados.txt"))
            {
                File.Create("empleados.txt").Close();
                Console.WriteLine("Archivo empleados.txt creado.");
            }
    ...
    class EmpleadoPorHoras : Empleado
    {
        ...
        public EmpleadoPorHoras(string nombre, double salarioPorHora, int horasTrabajadas) : base(nombre, salarioPorHora * horasTrabajadas)
        {
        ...
        public override string ToString()
        {
            return base.ToString() + $", Horas trabajadas: {HorasTrabajadas}, Salario por hora: {SalarioPorHora:C} (Por Horas)";
        }
    }
}
